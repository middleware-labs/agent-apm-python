...
from opentelemetry.resourcedetector.gcp_resource_detector._detector import GoogleCloudResourceDetector
...
def process_detector_input(input_value: Union[str,List[Detector]]):
    ...
    # If input is already a list, ensure it contains Detector enums
        ...
        raise TypeError("Input must be either a string or a list of Detector Enum members")
